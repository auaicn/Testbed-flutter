...
class CameraPage extends StatefulWidget {
  ...
  CameraPage({Key key, this.camera, this.didProvideImagePath}) : super(key: key);
...
class _CameraPageState extends State<CameraPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 5
      floatingActionButton: FloatingActionButton(child: Icon(Icons.camera), onPressed: _takePicture),
    );
  }
